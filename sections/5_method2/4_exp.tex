...
Hyperparameters were determined using a grid search over \gls{cvca} dropout probability (0.1 to 0.7, intervals of 0.2), learning rate (1e-4, 0.001, 0.01, 0.1, 0.3), and optimizer (SGD, ADAM).
...
\gls{sys} was implemented using SciPy, PyTorch Lightning, and FAISS \cite{johnson2019billion}. Computation was performed on four Nvidia RTX A6000 GPUs.
...
\end{itemize}
A baseline method similar to \gls{sys}, DFB \cite{ding2024improving}, was also included for consideration. For all baseline methods, the recommended hyperparemeters cited within each work were used.
...
%\gls{sys}  & 85.42$_{\pm 0.09}$ & \textbf{88.30}$_{\pm 0.04}$ & \textbf{93.26}$_{\pm 0.16}$ & \textbf{89.66}$_{\pm 0.15}$ & \textbf{91.34}$_{\pm 0.61}$ & \textbf{89.60} & 99.02$_{\pm 0.07}$ & \textbf{99.89}$_{\pm 0.01}$ & \textbf{98.46}$_{\pm 0.13}$ & \textbf{96.40}$_{\pm 0.06}$ & \textbf{95.55}$_{\pm 0.13}$ & \textbf{94.56}$_{\pm 0.25}$ & \textbf{97.31} & \textbf{93.81} \\ \hline
...
%\gls{sys}  & \textbf{85.03}$_{\pm 0.95}$ & \textbf{86.93}$_{\pm 0.67}$ & \textbf{89.96}$_{\pm 0.27}$ & \textbf{82.54}$_{\pm 0.68}$ & \textbf{87.14}$_{\pm 2.96}$ & \textbf{86.32} & \textbf{98.48}$_{\pm 0.49}$ & \textbf{99.42}$_{\pm 0.11}$ & \textbf{98.26}$_{\pm 0.20}$ & \textbf{97.81}$_{\pm 0.13}$ & \textbf{94.14}$_{\pm 0.30}$ & \textbf{86.60}$_{\pm 0.59}$ & \textbf{95.79} & \textbf{91.48} \\ \hline
%		\end{tabular}
%	}
...
\gls{sys}  & 85.42$_{\pm 0.09}$ & \textbf{88.30}$_{\pm 0.04}$ & \textbf{93.26}$_{\pm 0.16}$ & \textbf{89.66}$_{\pm 0.15}$ & \textbf{91.34}$_{\pm 0.61}$ & \textbf{89.60} \\ \hline
...
\gls{sys}  & \textbf{85.03}$_{\pm 0.95}$ & \textbf{86.93}$_{\pm 0.67}$ & \textbf{89.96}$_{\pm 0.27}$ & \textbf{82.54}$_{\pm 0.68}$ & \textbf{87.14}$_{\pm 2.96}$ & \textbf{86.32}  \\ \hline
		\end{tabular}
	}
	\label{tab:table_ood_auc}
\end{table*}
...
\gls{sys}  & \textbf{89.60} & 99.02$_{\pm 0.07}$ & \textbf{99.89}$_{\pm 0.01}$ & \textbf{98.46}$_{\pm 0.13}$ & \textbf{96.40}$_{\pm 0.06}$ & \textbf{95.55}$_{\pm 0.13}$ & \textbf{94.56}$_{\pm 0.25}$ & \textbf{97.31} & \textbf{93.81} \\ \hline
...
\gls{sys}  &  \textbf{86.32} & \textbf{98.48}$_{\pm 0.49}$ & \textbf{99.42}$_{\pm 0.11}$ & \textbf{98.26}$_{\pm 0.20}$ & \textbf{97.81}$_{\pm 0.13}$ & \textbf{94.14}$_{\pm 0.30}$ & \textbf{86.60}$_{\pm 0.59}$ & \textbf{95.79} & \textbf{91.48} \\ \hline
		\end{tabular}
	}
...
%	\small
%	\centering
%	\caption{\textbf{ImageNet-100 and ImageNet-200 Results - FPR95}: FPR95 OOD detection results between \gls{sys} and baselines for models trained only on ImageNet-100 ID data (top) or ImageNet-200 ID data (bottom). Avg.N is mean performance for near-OOD. Avg.F is mean performance for far-OOD.
%	}
%    \scalebox{0.58}{
%		\begin{tabular}{|l|ccccc|c|cccccc|c|c|}
%			\hline
...
%\gls{sys}    & \textbf{52.93}$_{\pm  1.01}$  & \textbf{53.69}$_{\pm  0.27}$  & \textbf{35.92}$_{\pm  0.57}$  & \textbf{48.49}$_{\pm  0.70}$  & \textbf{53.50}$_{\pm  4.86}$  & \textbf{48.91}  &  4.85$_{\pm  0.13}$  &  \textbf{0.22}$_{\pm  0.04}$  &  \textbf{7.81}$_{\pm  0.50}$  & \textbf{17.58}$_{\pm  0.62}$  & 26.53$_{\pm  0.64}$  & \textbf{23.94}$_{\pm  1.05}$  & \textbf{13.49}  & \textbf{29.59} \\ \hline
%			\multirow{2}{*}{} &  \multicolumn{14}{c|}{ID data: ImageNet-200}  \\ \cline{2-15}
%			& I-100-T & I-800  & NINCO & SSB-Hard & Food & Avg.N & Textures  & iNaturalist  & Places  & SUN & OpenImage-O & Species & Avg.F & Avg. \\ \hline
...
%\gls{sys}  & 59.39$_{\pm 1.17}$ & \textbf{53.33}$_{\pm 0.89}$ & \textbf{50.29}$_{\pm 1.86}$ & \textbf{63.95}$_{\pm 2.37}$ & \textbf{77.17}$_{\pm 4.48}$ & \textbf{60.83} &  \textbf{5.44}$_{\pm 1.22}$ &  \textbf{1.61}$_{\pm 0.47}$ &  \textbf{7.24}$_{\pm 0.84}$ & \textbf{10.55}$_{\pm 0.67}$ & \textbf{37.13}$_{\pm 2.65}$ & \textbf{50.99}$_{\pm 0.22}$ & \textbf{18.83} & \textbf{37.92} \\ \hline
%		\end{tabular}
%	}
...
\gls{sys}    & \textbf{52.93}$_{\pm  1.01}$  & \textbf{53.69}$_{\pm  0.27}$  & \textbf{35.92}$_{\pm  0.57}$  & \textbf{48.49}$_{\pm  0.70}$  & \textbf{53.50}$_{\pm  4.86}$  & \textbf{48.91}   \\ \hline
			\multirow{2}{*}{} &  \multicolumn{6}{c|}{ID data: ImageNet-200}  \\ \cline{2-7}
			& I-100-T & I-800  & NINCO & SSB-Hard & Food & Avg.N\\ \hline
...
\gls{sys}  & 59.39$_{\pm 1.17}$ & \textbf{53.33}$_{\pm 0.89}$ & \textbf{50.29}$_{\pm 1.86}$ & \textbf{63.95}$_{\pm 2.37}$ & \textbf{77.17}$_{\pm 4.48}$ & \textbf{60.83}\\ \hline
		\end{tabular}
	}
	\label{tab:table_ood_fpr95}
\end{table*}
...
\gls{sys}    &  \textbf{48.91}  &  4.85$_{\pm  0.13}$  &  \textbf{0.22}$_{\pm  0.04}$  &  \textbf{7.81}$_{\pm  0.50}$  & \textbf{17.58}$_{\pm  0.62}$  & 26.53$_{\pm  0.64}$  & \textbf{23.94}$_{\pm  1.05}$  & \textbf{13.49}  & \textbf{29.59} \\ \hline
			\multirow{2}{*}{} &  \multicolumn{9}{c|}{ID data: ImageNet-200}  \\ \cline{2-10}
			&  Avg.N & Textures  & iNaturalist  & Places  & SUN & OpenImage-O & Species & Avg.F & Avg. \\ \hline
...
\gls{sys}  &  \textbf{60.83} &  \textbf{5.44}$_{\pm 1.22}$ &  \textbf{1.61}$_{\pm 0.47}$ &  \textbf{7.24}$_{\pm 0.84}$ & \textbf{10.55}$_{\pm 0.67}$ & \textbf{37.13}$_{\pm 2.65}$ & \textbf{50.99}$_{\pm 0.22}$ & \textbf{18.83} & \textbf{37.92} \\ \hline
		\end{tabular}
	}
...
%	\small
%	\centering
%	\caption{\textbf{ImageNet-100 and ImageNet-200 Results - AUPR-IN}: AUPR-IN OOD detection results between \gls{sys} and baselines for models trained only on ImageNet-100 ID data (top) or ImageNet-200 ID data (bottom). Avg.N is mean performance for near-OOD. Avg.F is mean performance for far-OOD.
%	}
%	\scalebox{0.58}{
%		\begin{tabular}{|l|ccccc|c|cccccc|c|c|}
%			\hline
...
%\gls{sys}  & 92.49$_{\pm 0.13}$ & 52.10$_{\pm 0.18}$ & \textbf{92.10}$_{\pm 0.20}$ & 51.91$_{\pm 0.41}$ & \textbf{81.85}$_{\pm 0.44}$ & \textbf{74.09} & \textbf{98.84}$_{\pm 0.08}$ & \textbf{99.81}$_{\pm 0.02}$ & \textbf{97.04}$_{\pm 0.18}$ & \textbf{92.35}$_{\pm 0.14}$ & \textbf{89.70}$_{\pm 0.16}$ & \textbf{88.56}$_{\pm 0.40}$ & \textbf{94.38} & \textbf{85.16} \\ \hline
%			\multirow{2}{*}{} &  \multicolumn{14}{c|}{ID data: ImageNet-200}  \\ \cline{2-15}
%			& I-100-T & I-800  & NINCO & SSB-Hard & Food & Avg.N & Textures  & iNaturalist  & Places  & SUN & OpenImage-O & Species & Avg.F & Avg. \\ \hline
...
%\gls{sys}  & 91.33$_{\pm 0.72}$ & \textbf{64.74}$_{\pm 2.06}$ & \textbf{93.30}$_{\pm 0.17}$ & \textbf{46.75}$_{\pm 0.90}$ & \textbf{84.28}$_{\pm 2.56}$ & \textbf{76.08} & \textbf{98.84}$_{\pm 0.49}$ & \textbf{99.48}$_{\pm 0.09}$ & \textbf{98.14}$_{\pm 0.24}$ & \textbf{97.82}$_{\pm 0.16}$ & \textbf{92.19}$_{\pm 0.32}$ & \textbf{83.87}$_{\pm 1.55}$ & \textbf{95.06} & \textbf{86.43} \\ \hline
%		\end{tabular}
%	}
...
\gls{sys}  & 92.49$_{\pm 0.13}$ & 52.10$_{\pm 0.18}$ & \textbf{92.10}$_{\pm 0.20}$ & 51.91$_{\pm 0.41}$ & \textbf{81.85}$_{\pm 0.44}$ & \textbf{74.09}  \\ \hline
			\multirow{2}{*}{} &  \multicolumn{6}{c|}{ID data: ImageNet-200}  \\ \cline{2-7}
			& I-100-T & I-800  & NINCO & SSB-Hard & Food & Avg.N\\ \hline
...
\gls{sys}  & 91.33$_{\pm 0.72}$ & \textbf{64.74}$_{\pm 2.06}$ & \textbf{93.30}$_{\pm 0.17}$ & \textbf{46.75}$_{\pm 0.90}$ & \textbf{84.28}$_{\pm 2.56}$ & \textbf{76.08} \\ \hline
		\end{tabular}
	}
	\label{tab:table_ood_auprin}
\end{table*}
...
\gls{sys}  & \textbf{74.09} & \textbf{98.84}$_{\pm 0.08}$ & \textbf{99.81}$_{\pm 0.02}$ & \textbf{97.04}$_{\pm 0.18}$ & \textbf{92.35}$_{\pm 0.14}$ & \textbf{89.70}$_{\pm 0.16}$ & \textbf{88.56}$_{\pm 0.40}$ & \textbf{94.38} & \textbf{85.16} \\ \hline
			\multirow{2}{*}{} &  \multicolumn{9}{c|}{ID data: ImageNet-200}  \\ \cline{2-10}
			&  Avg.N & Textures  & iNaturalist  & Places  & SUN & OpenImage-O & Species & Avg.F & Avg. \\ \hline
...
\gls{sys}  &  \textbf{76.08} & \textbf{98.84}$_{\pm 0.49}$ & \textbf{99.48}$_{\pm 0.09}$ & \textbf{98.14}$_{\pm 0.24}$ & \textbf{97.82}$_{\pm 0.16}$ & \textbf{92.19}$_{\pm 0.32}$ & \textbf{83.87}$_{\pm 1.55}$ & \textbf{95.06} & \textbf{86.43} \\ \hline
		\end{tabular}
	}
...
%	\small
%	\centering
%	\caption{\textbf{ImageNet-100 and ImageNet-200 Results - AUPR-OUT}: AUPR-OUT OOD detection results between \gls{sys} and baselines for models trained only on ImageNet-100 ID data (top) or ImageNet-200 ID data (bottom). Avg.N is mean performance for near-OOD. Avg.F is mean performance for far-OOD.
%	}
%	\scalebox{0.58}{
%		\begin{tabular}{|l|ccccc|c|cccccc|c|c|}
%			\hline
...
%\gls{sys}  & 72.04$_{\pm 0.35}$ & \textbf{98.45}$_{\pm 0.01}$ & \textbf{94.19}$_{\pm 0.11}$ & \textbf{98.76}$_{\pm 0.02}$ & \textbf{97.24}$_{\pm 0.31}$ & \textbf{92.14} & \textbf{99.21}$_{\pm 0.06}$ & \textbf{99.94}$_{\pm 0.00}$ & \textbf{99.24}$_{\pm 0.08}$ & \textbf{98.24}$_{\pm 0.02}$ & \textbf{98.57}$_{\pm 0.05}$ & \textbf{97.37}$_{\pm 0.13}$ & \textbf{98.76} & \textbf{95.75} \\ \hline
%			\multirow{2}{*}{} &  \multicolumn{14}{c|}{ID data: ImageNet-200}  \\ \cline{2-15}
%			& I-100-T & I-800  & NINCO & SSB-Hard & Food & Avg.N & Textures  & iNaturalist  & Places  & SUN & OpenImage-O & Species & Avg.F & Avg. \\ \hline
...
%\gls{sys}  & \textbf{75.02}$_{\pm 0.80}$ & \textbf{96.24}$_{\pm 0.14}$ & \textbf{83.54}$_{\pm 0.50}$ & \textbf{95.73}$_{\pm 0.20}$ & \textbf{89.96}$_{\pm 2.88}$ & \textbf{88.10} & \textbf{98.01}$_{\pm 0.50}$ & \textbf{99.28}$_{\pm 0.20}$ & \textbf{98.23}$_{\pm 0.15}$ & \textbf{97.50}$_{\pm 0.05}$ & \textbf{95.98}$_{\pm 0.20}$ & \textbf{87.41}$_{\pm 0.27}$ & \textbf{96.07} & \textbf{92.45} \\ \hline
%		\end{tabular}
%	}
...
\gls{sys}  & 72.04$_{\pm 0.35}$ & \textbf{98.45}$_{\pm 0.01}$ & \textbf{94.19}$_{\pm 0.11}$ & \textbf{98.76}$_{\pm 0.02}$ & \textbf{97.24}$_{\pm 0.31}$ & \textbf{92.14}  \\ \hline
			\multirow{2}{*}{} &  \multicolumn{6}{c|}{ID data: ImageNet-200}  \\ \cline{2-7}
			& I-100-T & I-800  & NINCO & SSB-Hard & Food & Avg.N\\ \hline
...
\gls{sys}  & \textbf{75.02}$_{\pm 0.80}$ & \textbf{96.24}$_{\pm 0.14}$ & \textbf{83.54}$_{\pm 0.50}$ & \textbf{95.73}$_{\pm 0.20}$ & \textbf{89.96}$_{\pm 2.88}$ & \textbf{88.10}  \\ \hline
		\end{tabular}
	}
	\label{tab:table_ood_auprout}
\end{table*}
...
\gls{sys}  & \textbf{92.14} & \textbf{99.21}$_{\pm 0.06}$ & \textbf{99.94}$_{\pm 0.00}$ & \textbf{99.24}$_{\pm 0.08}$ & \textbf{98.24}$_{\pm 0.02}$ & \textbf{98.57}$_{\pm 0.05}$ & \textbf{97.37}$_{\pm 0.13}$ & \textbf{98.76} & \textbf{95.75} \\ \hline
			\multirow{2}{*}{} &  \multicolumn{9}{c|}{ID data: ImageNet-200}  \\ \cline{2-10}
			&  Avg.N & Textures  & iNaturalist  & Places  & SUN & OpenImage-O & Species & Avg.F & Avg. \\ \hline
...
\gls{sys}  & \textbf{88.10} & \textbf{98.01}$_{\pm 0.50}$ & \textbf{99.28}$_{\pm 0.20}$ & \textbf{98.23}$_{\pm 0.15}$ & \textbf{97.50}$_{\pm 0.05}$ & \textbf{95.98}$_{\pm 0.20}$ & \textbf{87.41}$_{\pm 0.27}$ & \textbf{96.07} & \textbf{92.45} \\ \hline
		\end{tabular}
	}
...
\gls{sys}   & \textbf{93.02}  &  \textbf{98.50}  &  90.38  &  \textbf{93.97}  &  86.35  &  \textbf{72.96}  &  \textbf{77.60}  &  \textbf{78.97}  &  \textbf{86.47}   \\ \hline
\end{tabular}
}
...
\gls{sys}   &  35.96  &  \textbf{5.93}  &  50.16  &  30.68  &  59.43  &  \textbf{74.54}  &  \textbf{90.42}  &  74.80  &  52.74  \\ \hline
\end{tabular}
}
...
\gls{sys}   &  99.12 & \textbf{99.64} & 96.36 & \textbf{98.37} & 98.08 & \textbf{70.79} & 86.62 & \textbf{85.16} & \textbf{91.77}
  \\ \hline
\end{tabular}
}
...
\gls{sys}   &  \textbf{61.95} & \textbf{94.65} & 74.22 & \textbf{76.94} & 43.95 & 73.09 & \textbf{51.88} & 56.31 & \textbf{66.62}  \\ \hline
\end{tabular}
}
...
Results for \gls{sys} and baselines on the large-scale ImageNet-1k ID dataset are presented in Tables \ref{tab:table_main_i1k_auc} (AUC), \ref{tab:table_main_i1k_fpr95} (FPR95), \ref{tab:table_main_i1k_auprin} (AUPR-IN), and \ref{tab:table_main_i1k_auprout} (AUPR-OUT). %, and \ref{tab:table_main_i1k_de} (DE). 
...
On average, \gls{sys} outperforms previous state-of-the-art OOD detection baselines. Considering AUC, \gls{sys} achieves state-of-the-art performance. Near-OOD AUC is improved by 0.61\% and far-OOD AUC is improved by 1.13\%. Across all datasets, the average AUC is improved by 0.99\%, a significant margin in the ImageNet-1k domain. Of particular note is the performance of \gls{sys} on the near-OOD datasets, which are designed specifically to be close to the ImageNet-1k ID data (and feature) distribution. On NINCO, \gls{sys} only underperforms by 0.17\%, while in SSB-HARD \gls{sys} improves over previous baselines by 1.39\% and in Food \gls{sys} improves by 0.61\%. With the expansive semantic space of ImageNet-1k (1000 fine-grained classes), the ability of \gls{sys} to learn ID class-representative discriminative features via \gls{cvca} gives it an advantage over previous, single-view baselines. Of note is that the parallel work of DFB \cite{ding2024improving} also experimented with ImageNet-1k but at a limited scale. DFB only experimented with Textures and performed with an AUC of 77\%. This is 16.02\% less than \gls{sys}. The explicit segmentation and feature fusion used in \gls{sys}, via \gls{cvca}, enables the learning of a feature space more conducive to OOD detection.

For the other OOD detection metrics, \gls{sys} likewise outperforms previous baselines or performs equivalently. With FPR95, \gls{sys} on average performs very similarly to the best previous baseline, a difference of only 0.36\%. However, with AUPR-IN and AUPR-OUT, \gls{sys} improves over the state-of-the-art baselines. With AUPR-IN, the average is improved by 1.59\%. With AUPR-OUT, the average is improved by 1.90\%. In these other OOD detection metrics, \gls{sys} demonstrates competent OOD detection performance, indicating significant robustness in the challenging ImageNet-1k setting.

ID accuracy, despite not being prioritized in recent OOD detection works, is preserved by \gls{sys} with the major architectural changes (with \gls{cvca}) and large-scale, challenging datasets. For ImageNet-1k ID, \gls{sys} performs with a classification accuracy of 80.00\%. The baseline models performs with a classification accuracy of 80.10\%, a difference of only 0.10\%. \gls{sys} maintains equivalent ID accuracy while significantly improving OOD detection in experimental settings representative of real-world environments and tasks.
