...
\multirow{7}{*}{Qwen-8B}   &  MaxLogit                    &   46.59  &  50.28  &   43.69  &  49.81   &  79.08   &   52.36  &   \multicolumn{1}{|c|}{53.64}  \\ 
                             ...
                             &  \textit{\gls{syst} (AUC)} &  90.90  &  98.38  &  92.86  &  56.52  &  86.46  &  96.46  &   \multicolumn{1}{|c|}{ \textbf{86.93}}  \\ \cline{2-9}
                             ...
                             &  \cellcolor{rowGray} \textit{\gls{syst} (F)} &  \cellcolor{rowGray} 85.63  &  \cellcolor{rowGray} 94.01  & \cellcolor{rowGray} 87.17  & \cellcolor{rowGray} 43.97  &  \cellcolor{rowGray} 76.85  &  \cellcolor{rowGray} 81.89  &   \multicolumn{1}{|c|}{ \cellcolor{rowGray} \textbf{78.25}}  \\ \hline
\multirow{7}{*}{Gemma-12B}   &  MaxLogit                    &   50.58  &  52.93  &   41.45  &   54.92  &   74.35  &   57.02  &   \multicolumn{1}{|c|}{55.21}  \\ 
                             ...
                             &  \textit{\gls{syst} (AUC)} &  92.37  &   99.07  &  96.13  &  68.40  &  81.30  &  95.16  &   \multicolumn{1}{|c|}{ \textbf{88.74}}  \\ \cline{2-9}
                             ...
                             &  \cellcolor{rowGray} \textit{\gls{syst} (F)} &  \cellcolor{rowGray} 87.72  &  \cellcolor{rowGray} 91.78  & \cellcolor{rowGray} 87.45  & \cellcolor{rowGray} 64.29  &  \cellcolor{rowGray} 72.97  &  \cellcolor{rowGray} 83.82  &   \multicolumn{1}{|c|}{ \cellcolor{rowGray} \textbf{81.34}}  \\ \hline
\end{tabular}
}
...
Similar to the previous ablation study, the performance of any given prompt-only OOD detection method may change significantly based on how many ID classes $C$ are provided in the prompt. For \gls{syst}, this impact is is investigated by experimenting with 10 ID classes across Qwen-8B and Gemma-12B over all OOD datasets. Results are presented in \ref{tab:atpo_results-icl10}. The larger quantity of ID classes generally decreases OOD detection performance for all considered methods as the larger ID space increases the complexity of the domain. However, \gls{syst} still outperforms baselines in this complex setting, demonstrating the robustness of the proposed lexical and semantic alignment approach.
...
\multirow{6}{*}{Mistral-7B}  %&  --Alignment {\color{red}TODO}    &   90.55  &   97.71  &   99.60  &   71.35  &   69.79  &   61.57  &   \multicolumn{1}{|c|}{81.76}  \\
                             ...
                             &  Nonspecified Alignment (\gls{syst}-NA)  &   86.03  &   96.00  &   89.42  &   50.88  &   90.18  &   76.60  &  \multicolumn{1}{|c|}{81.52}  \\
                             &  Dissimilar &   87.42  &   81.91  &   86.93  &   65.87  &   80.46  &   80.58  &  \multicolumn{1}{|c|}{80.53}  \\  
                            &   \textit{\gls{syst}}  &   92.14  &   94.97  &   93.87  &   65.01  &   89.36  &   82.09  &  \multicolumn{1}{|c|}{\textbf{86.24}}  \\  \hline
\multirow{6}{*}{Qwen-8B}    
                             ...
                             &  Nonspecified Alignment (\gls{syst}-NA)  &   91.95  &   96.20  &   92.79  &   67.13  &   88.46  &   91.09  &   \multicolumn{1}{|c|}{87.94}  \\
                             &  Dissimilar  &   96.22  &   99.06  &   96.23  &   53.38  &   94.48  &   95.81  &  \multicolumn{1}{|c|}{89.20}  \\  
                            &   \textit{\gls{syst}}  &   96.43  &  99.24  &   94.95  &  77.96  &  94.61  &   95.41  &  \multicolumn{1}{|c|}{ \textbf{93.10}}  \\  \hline
\multirow{6}{*}{Gemma-12B}   %&  --Alignment {\color{red}TODO}    &   37.64  &  68.89  &   20.54  &   52.41  &   52.66  &   56.88  &   \multicolumn{1}{|c|}{48.17}  \\ 
                             ...
                             &  Nonspecified Alignment (\gls{syst}-NA)  &   97.25  &   99.45  &   98.47  &   68.24  &   95.71  &   96.28  &   \multicolumn{1}{|c|}{92.57}  \\ 
                             &  Dissimilar  &   92.54  &   99.17  &   98.05  &   81.67  &   92.83  &   93.50  &  \multicolumn{1}{|c|}{92.96}  \\  
                            &   \textit{\gls{syst}}  &   95.96  &  99.52  &   98.87  &  79.46  &  92.25  &   96.45  &  \multicolumn{1}{|c|}{\underline{93.75}}  \\  \hline
\multirow{6}{*}{Deepseek-32B}    
                             ...
                             &  Nonspecified Alignment (\gls{syst}-NA)  &   97.10  &   99.54  &   98.75  &   72.74  &   93.04  &   96.18  &   \multicolumn{1}{|c|}{92.89}  \\
                             &  Dissimilar  &   95.80  &   98.01  &   96.73  &   83.60  &   91.05  &   94.67  &  \multicolumn{1}{|c|}{93.31}  \\  
                            &   \textit{\gls{syst}}  &   96.83  &  99.44  &   98.62  &  81.86  &  93.55  &   97.44  &  \multicolumn{1}{|c|}{ 94.62}  \\  \hline
\end{tabular}
}
...
\multirow{5}{*}{Mistral-7B}  &  Role Change &   89.94  &   89.15  &   89.76  &   54.38  &   81.58  &   84.70  &   \multicolumn{1}{|c|}{81.59}  \\
                             ...
                             &  \textit{\gls{syst}-R}  &   87.14  &   86.28  &   85.21  &   53.95  &   76.74  &   76.68  &  \multicolumn{1}{|c|}{77.67}  \\  
                            &   \textit{\gls{syst}}  &   92.14  &   94.97  &   93.87  &   65.01  &   89.36  &   82.09  &  \multicolumn{1}{|c|}{\textbf{86.24}}  \\  \hline
...
\multirow{5}{*}{Qwen-8B}   &  Role Change &  82.53   &  89.32  &   85.88  &   67.04  &   80.82  &   82.48  &   \multicolumn{1}{|c|}{81.35}  \\ 
                             ...
                             &   \textit{\gls{syst}-R}  &   95.73  &   98.60  &   96.34  &   75.73  &   93.02  &   87.02  &   \multicolumn{1}{|c|}{91.07}  \\ 
                            &   \textit{\gls{syst}}  &   96.43  &  99.24  &   94.95  &  77.96  &  94.61  &   95.41  &  \multicolumn{1}{|c|}{\textbf{93.10}}  \\  \hline
...
\multirow{5}{*}{Gemma-12B}     &  Role Change &   90.41  &   73.35  &   97.83  &   59.68  &   70.31  &   84.48  &   \multicolumn{1}{|c|}{79.34}  \\
                             ...
                             &   \textit{\gls{syst}-R}  &   97.53  &   99.03  &   97.80  &   72.75  &   95.73  &   94.97  &   \multicolumn{1}{|c|}{92.97}  \\ 
                            &   \textit{\gls{syst}}  &   95.96  &  99.52  &   98.87  &  79.46  &  92.25  &   96.45  &  \multicolumn{1}{|c|}{\textbf{93.75}}  \\  \hline
...
\multirow{5}{*}{Deepseek-32B} &  Role Change &   95.05  &  99.60  &   98.23  &   72.07  &   92.94  &   91.94  &   \multicolumn{1}{|c|}{91.64}  \\ 
                             ...
                             &   \textit{\gls{syst}-R}  &   96.43  &   99.63  &   98.26  &   84.39  &   92.91  &   89.46  &   \multicolumn{1}{|c|}{93.51}  \\ 
                            &   \textit{\gls{syst}}  &   96.83  &  99.44  &   98.62  &  81.86  &  93.55  &   97.44  &  \multicolumn{1}{|c|}{\textbf{94.62}}  \\  \hline
\end{tabular}
}
...
Prompt sensitivity in \gls{syst} is investigated by modulating the prompt in the same experimental procedure defined in the previous baseline \cite{wang2024beyond}. The following prompt modulations are considered:
...
Through the use of lexical and semantic alignment via prompting, as well as subsequent thresholding of generated OOD scores, \gls{syst} achieves state-of-the-art prompt-only OOD detection performance. The latent knowledge in LLMs is leveraged via ICL prompts and alignment-based reasoning to clearly isolate OOD samples without the use of any fine-tuning or access to LLM components, features, or logits. This makes \gls{syst} extraordinarily efficient and accessible to users, eliminating any blocks from the requirements of expert knowledge, ML programming experience, or computational resources. In the settings of real-world applications and near-OOD data, \gls{syst} excels as an OOD detection method for the open-world.