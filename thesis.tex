...
\usepackage[colorlinks=true,citecolor=black,linkcolor=black,linktocpage=true]{hyperref}
%\usepackage{xcolor}
%\hypersetup{
%colorlinks,
%allcolors=.,
...
%\printglossary
\centerline{\textbf{Acronyms}}

\textbf{ATPO:} Alignment-based Thresholding for Prompt-only OOD detection

\textbf{CASOD:} Cross-view Attention of Segmented views for OOD Detection

\textbf{CVCA:} Cross-View Correlation Attention

\textbf{ICL:} In-Context Learning

\textbf{ID:} In-Distribution

\textbf{IST:} Image Segmentation Tool

\textbf{MEO:} Multi-view Ensemble for OOD detection

\textbf{MOD:} Multi-view OOD Detection

\textbf{MVCNN:} Multi-View Convolutional Neural Network

\textbf{OOD:} Out-of-Distribution

\textbf{SCOD:} Selective Cross-view OOD Detection
...
\input{sections/2_bkgd/0_index}
\input{sections/3_relwork/0_index}
\input{sections/4_method1/0_index}
\input{sections/5_method2/0_index}
\input{sections/6_method3/0_index}
\input{sections/7_conc/0_index}
\newpage
\input{sections/8_appendix/0_index}
